...
if (isset($_GET['id'])) {
    ...
    $currentUsernameQuery = "SELECT c_username FROM `c_teacher` WHERE `c_teacher_id` = $teacherId";
...
<head>
    ...
    <title>Edit Faculty Username</title>
    <style>
        body {
            text-align: center;
